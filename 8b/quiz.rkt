...
;; consumes two rosters, and produces true if
...
#;
(define (all-play? r1 r2) true) ;stub

;; template from Roster

(define (all-play? r1 r2)
  (local [(define r1-empty? (empty? r1))
...
(check-expect (list-matches R2 R2) (list (make-match "Maria" "Maria")
